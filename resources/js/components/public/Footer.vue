            ...
            >
                ...
                <!-- <div class="text-center md:text-right">
                    <p class="text-xs text-gray-500 dark:text-gray-500">
                        ...
                        using Laravel, Inertia.js & Vue 3
                    </p>
                </div> -->
            </div>
